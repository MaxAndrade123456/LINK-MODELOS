...
const AdminPanel: React.FC = () => {
  ...
  // Calcula totais
  const totalViews = Object.values(stats).reduce((acc: number, curr: StatData) => acc + curr.views, 0);
  const totalClicks = Object.values(stats).reduce((acc: number, curr: StatData) => acc + curr.clicks, 0);
